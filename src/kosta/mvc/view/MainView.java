...
public class MainView {
	...
	public static void main(String[] args) {
	   ...
	   System.out.println("********** [4] 게시물 등록 *************");
		BoardController.insertBoard(new BoardDTO("Java기본문법", "이나영", "요약정리학습", null));//글번호 없는 게시물등록
		BoardController.insertBoard(new BoardDTO("WEB", "천송이", "초보개발자기초학습", null));//글번호 없는 게시물등록
		...
		BoardController.updateBoard(2, "myBatis수업");//글번호 있는 게시물 수정
